    ...
    <div class="row text-center">
      ...
      <div class="col text-center" style="margin: 20px;">
        <div class="card" style="padding:20px;">
          ...
          <tr><th>Name</th><th>Age</th><th>Blood Group</th><th>Email</th><th>Center</th><th>City</th><th>Date</th><th>Medical Histroy</th><th>Edit</th><th>Delete</th></tr>
            <?php
              $ret=pg_query($db,"select dname,dage,dbg,demail,dcentre,dcity,ddate,dmedhist from df;");
                if(isset($_POST['search']))
                {
                    $sub=$_POST['search'];
                    $str="select dname,dage,dbg,demail,dcentre,dcity,ddate,dmedhist from df where concat(dname,dage,dbg,demail,dcentre,dcity,ddate,dmedhist) like '%".$sub."%';";
                    $s=pg_query($db,$str);
