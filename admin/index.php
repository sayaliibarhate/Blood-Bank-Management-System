    ...
    <div class="row text-center">
      <div class="col-md-2">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link " id="v-pills-settings-tab" data-toggle="pill" href="index.php" role="tab" aria-controls="v-pills-users" aria-selected="false">Users</a>
      ...
      <div class="col text-center" style="margin: 20px;">
        <div class="card" style="padding:20px;">
          ...
          <tr><th>Name</th><th>Gender</th><th>Age</th><th>Email</th><th>Blood Group</th><th>City</th><th>Phone</th></tr>
            <?php
              $ret=pg_query($db,"select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Donor' and status='Active';");
                if(isset($_POST['search']))
                {
                    $sub=$_POST['search'];
                    $str="select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where concat(rname,rgender,rage,remail,rbloodgroup,rcity,rphone) like '%".$sub."%';";
                    $s=pg_query($db,$str);
                    ...
                    {   
                      ...
                      <td>".$row[5]."</td>
                      <td>".$row[6]."</td>";
                      /*<td><form action='Operation/view.php' method='post'>
                      <button type='submit' class='btn btn-default' name='view' value='".$row[3]."'>View</button>
                      </form></td>
                      <td>
                      <form action='Operation/delete.php' method='post'>
                      <button type='submit' class='btn btn-default' name='del' value='".$row[3]."'>Delete</button>
                      </form>
                      </td></tr>";*/
                    }
                }
                ...
                while($row=pg_fetch_row($ret))
                {
                   ...
                   <td>".$row[6]."</td>";
                   /*<td>
                   <form action='Operation/view.php' method='post'>
                   <button type='submit' class='btn btn-default' name='view' value='".$row[3]."'>View</button>
                   </form>
                   </td>
                   <td>
...
<div class="col">
        <div class="card" style="margin: 20px 0;padding:20px;">
          ...
          <tr><th>Name</th><th>Gender</th><th>Age</th><th>Email</th><th>Blood Group</th><th>City</th><th>Phone</th></tr>
            <?php
              $ret=pg_query($db,"select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Donor' and status='Inactive';");
                if(isset($_POST['search']))
                {
                    $sub=$_POST['search'];
                    $str="select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Donor' and status='Active' concat(rname,rgender,rage,remail,rbloodgroup,rcity,rphone) like '%".$sub."%';";
                    $s=pg_query($db,$str);
                    while($row=pg_fetch_row($s))
                    {   
                      echo "<tr>
...
<hr class=solid style="color:darkslategray;">
<div class="card" style="margin: 20px 0;padding:20px;">
          <center>

          <h4> Receivers: Active</h4>
          <hr class="solid">
          <form action="" method="post" style="float:right;padding:10px 40px 20px 0px;">
              <input type="text" name="search" placeholder="Search">
              <button type="submit" value="Search" class="btn btn-success"><i class="fa fa-search"></i></button>
          ...
          <tr><th>Name</th><th>Gender</th><th>Age</th><th>Email</th><th>Blood Group</th><th>City</th><th>Phone</th></tr>
            <?php
              $ret=pg_query($db,"select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Receiver' and status='Active';");
                if(isset($_POST['search']))
                {
                    $sub=$_POST['search'];
                    $str="select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Donor' and status='Active' concat(rname,rgender,rage,remail,rbloodgroup,rcity,rphone) like '%".$sub."%';";
        ...
        <div class="card" style="margin:0 0 20px 0;padding:20px;">
          ...
          <tr><th>Name</th><th>Gender</th><th>Age</th><th>Email</th><th>Blood Group</th><th>City</th><th>Phone</th></tr>
            <?php
              $ret=pg_query($db,"select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Receiver' and status='Inactive';");
                if(isset($_POST['search']))
                {
                    $sub=$_POST['search'];
                    $str="select rname,rgender,rage,remail,rbloodgroup,rcity,rphone from users where act='Donor' and status='Active' concat(rname,rgender,rage,remail,rbloodgroup,rcity,rphone) like '%".$sub."%';";
