  ...
  <link rel="icon" type="image/x-icon" href="favicon.ico">
    ...
    <body>
        ...
        <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist" style="margin:-140px 0 0 -80px;">
            ...
            <li class="nav-item" role="presentation" >
                <a href="papphist.php" class="nav-link active" id="profile-tab0" data-mdb-toggle="tab" data-mdb-target="#profile0" type="button" role="tab"  aria-selected="false"  style="color:darkred;"> Appointment History </a>
            </li>
            <li class="nav-item" role="presentation">
        ...
        <center><p><h3>Appointment Booking History</h3></p></center><br>
        <div class="container" style="overflow-x:auto;">
<hr class="solid">

        <?php 
        $cnt=0;
        $str="select * from df where demail='".$_SESSION['uname']."';";
        $q=pg_query($db,$str);
        while($row=pg_fetch_row($q))
        {
            echo "<table><tr><th>Name: </th><td>".$row[0]. "</td>";
            echo "<th>Age: </th><td>".$row[1]. "</td></tr><tr><th>Adhaar Card: </th><td>".$row[2]. "</td></tr>
            <tr><th>Gender: </th><td>".$row[3]. "</td><th>Blood Group: </th><td>".$row[4]. "</td></tr>";
            echo "<tr><th>Mobile: </th><td>".$row[5]. "</td><th>Email: </th><td>".$row[6]. "</td></tr>";
            echo "<tr><th>Pincode: </th><td>".$row[7]. "</td><th>Address: </th><td>".$row[8]. "</td><th>City: </th><td>".$row[10]. "</td></tr>";
            echo "<tr><th>Last Donated: </th><td>".$row[11]. "</td></tr>";
            echo "<tr><th>Medical History: </th><td>".$row[13]. "</td><th>Other: </th><td>".$row[14]. "</td></tr>";
            echo "<tr><th>Tattoo: </th><td>".$row[15]. "</td><th>Tattoo History : </th><td>".$row[16]. "</td></tr>";
            echo "<tr><th><i class='fa fa-map-marker'></i> Center: </th><td>".$row[17]. "</td><th><i class='fa fa-calendar-check-o'></i> Date:</th><td>".$row[18]. "</td>
            <th><i class='fa fa-clock'></i> Time: </th><td>".$row[19]. "</td></tr></table>";
            echo "<hr class=solid>";
            $cnt++;
        }
        ?>
Appointments booked: <?php echo $cnt; ?>
<hr class="solid">
        </div>
        </div>
